...
export const ERROR_MESSAGE_CAR_NAME_INVALID = `${ERROR_MESSAGE_DEFAULT} 1글자 이상, 5글자 이하의 알파벳, 숫자 혹은 언더바(_)로 이루어진 자동차 이름을 입력해주세요`;
export const ERROR_MESSAGE_CAR_NAME_DUPLICATION = `${ERROR_MESSAGE_DEFAULT} 중복된 자동차 이름을 입력할 수 없습니다.`;
...
export const INPUT_MESSAGE_CAR_NAMES =
  "경주할 자동차 이름을 입력하세요.(이름은 쉼표(,) 기준으로 구분)";
export const INPUT_MESSAGE_TRY_COUNT = "시도할 횟수는 몇 회인가요?";

export const OUTPUT_MESSAGE_WINNER = "최종 우승자 : ";
