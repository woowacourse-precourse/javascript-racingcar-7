...
describe('자동차 경주', () => {
  ...
  test('시도 횟수에 문자열 입력', async () => {
    const inputs = ['pobi', 'woni', 'attempt!'];
    mockQuestions(inputs);
    const app = new App();
  ...
  test('자동차 이름이 쉼표로 시작하는 경우', async () => {
    const inputs = [',pobi,woni'];
    mockQuestions(inputs);
    const app = new App();
